...
targetUserComment2 = "Workshops with Bruce Almighty"
...
for post in range(0,len(posts)):
    ...
    if len(end_cursor) != 0 and (len(posts)-1) == post:
        ...
        userURL = baseURL+"graphql/query/?query_id=17888483320059182&id="+str(userID[0])+"&first=50"+"&after="+str(end_cursor[0])
